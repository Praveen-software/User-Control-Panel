<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nav side set.aspx.cs" Inherits="nav_side_set" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Dashbord MepPedia</title>
        ...
        <div class="sidenav h-100 modal-dialog bg-light">
            <div class="navbar">
                <a href="index.html" class="navbar-brand">
                    ...
                    <span class="hidden-folded d-inline l-s-n-1x">MepPedia</span>
                </a>
            </div>
    ...
    <div id="main" class="layout-column flex">
        <div id="header" class="page-header">
            <div class="navbar navbar-expand-lg"><a href="index.html" class="navbar-brand d-lg-none">
                ...
                <span class="hidden-folded d-inline l-s-n-1x d-lg-none">MepPedia</span></a>
                ...
                <ul class="nav navbar-menu order-1 order-lg-2">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link px-2 mr-lg-2" data-toggle="dropdown"><i data-feather="bell"></i><span class="badge badge-pill badge-up bg-primary">8</span></a><div class="dropdown-menu dropdown-menu-right mt-3 w-md animate fadeIn p-0">
                        <div class="scrollable hover" style="max-height: 250px">
                            <div class="list list-row">
                                <div class="list-item" data-id="10">
                                    <div><a href="#"><span class="w-32 avatar gd-danger">
                                        <img src="../assets/img/a10.jpg" alt="."/></span></a></div>
                                    <div class="flex">
                                ...
                                <div class="list-item" data-id="4">
                                    <div><a href="#"><span class="w-32 avatar gd-success">
                                        <img src="../assets/img/a4.jpg" alt="."></span></a></div>
                                    <div class="flex">
                    ...
                    <li class="nav-item dropdown"><a href="#" data-toggle="dropdown" class="nav-link d-flex align-items-center px-2 text-color">
